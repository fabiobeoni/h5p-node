...
describe('Testing main class for file system management, FileSystemDAL:', async()=> {
    ...
    it(`deepCopy(): Makes a FILTERED copy of an entire H5P library, 
        including sub paths and checks that all needed files are there
        after the copy`,
    ...
    it(`deepCopy(): Makes a FULL copy of an entire H5P library, 
        including sub paths and checks that all needed files 
        are there after the copy`,
    ...
    it(`filterFilesToIgnore(): Filters a list of files 
        based on ignore options and returns them`,
